...
void main()
{
 ...
 int no;
	...
	cout<<endl<<endl<<"\t"<<"113"<<"\t\t"<<"RANICHANNAMAEXP"<<"\t"<<"KOLHAPUR"<<"\t"<<"BANGLORE";
	cout<<endl<<"-----------------------------------------------------------------------";
		...
		case 113:
			cleardevice();
			cout<<endl<<endl<<"TRAIN NAME:"<<"RANICHANNAMA EXP";
			cout<<endl<<"------------------------------------------------";
			cout<<endl<<endl<<"\t"<<"FROM"<<"\t\t"<<"TO";
			cout<<endl<<"------------------------------------------------";
...
while(1)
  {                  //start while
    ...
    outtextxy(250,380+3*(textheight("Reserve")+5),"4:Main Menu");
	...
	if(x>=250&&x<=250+textwidth("4:Main Menu")&&y>=419&&y<=427)
	{
	 goto xyz;
	}
